...
const Footer = () => {
  return (
    <footer className="relative flex overflow-clip rounded-tl-2xl rounded-tr-2xl m-0 flex-col h-[96vh] py-20 justify-end">
      ...
      <div className="relative flex flex-col justify-center items-center text-white px-4 lg:px-0 gap-y-5">
        <h4 className="text-6xl">Your health at your fingertips</h4>
        <p className="mt-2 text-center lg:text-start">Access, manage and secure your health records all in one place</p>
